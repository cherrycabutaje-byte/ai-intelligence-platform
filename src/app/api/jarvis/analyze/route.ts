...
RESPONSE FORMAT - RETURN THIS EXACT JSON STRUCTURE:
{
  ...
  "market_score": 72,
  "confidence": 85,
 "do_this_now": "ONE specific action completable in 10 minutes. Must include exact URL and exact words. Example: Go to youtube.com/studio RIGHT NOW. Click Content. Find this video. Change title to [exact title]. This takes 5 minutes and will add 300+ views.",
