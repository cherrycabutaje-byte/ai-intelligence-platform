...
IMPORTANT: If scraped data is provided, use it as the PRIMARY source of intelligence.
Real data always beats assumptions. Build your analysis on actual titles, descriptions, and metrics.
...
Schema:
{
  ...
  "viral_score": 0-100,
  "market_score": 0-100,
  "scout_findings": "What opportunities exist right now in this niche and platform based on real data found",
  ...
  "viral_drivers": "What will make this content or product spread based on real data",
  ...
  "content_report": "Full business manager report spoken directly to the owner. Include what you found from real data, why it matters, and what they should do.",
...
Use the real scraped data above as your PRIMARY intelligence source.
