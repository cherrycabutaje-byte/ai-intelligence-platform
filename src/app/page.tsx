        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              {
                icon: "🔍",
                title: "12 Copy-Paste SEO Tags",
                desc: "Jarvis generates 12 perfectly targeted tags for your exact content — numbered and ready to paste into YouTube, Etsy, or Amazon. No guessing which keywords to use.",
                color: "cyan",
              },
              {
                icon: "🎬",
                title: "Hook Script Word For Word",
                desc: "Get the first 30 seconds of your next video written for you — second by second. 0-3s: pattern interrupt. 3-10s: agitate the pain. 10-30s: promise the transformation.",
                color: "purple",
              },
              {
                icon: "🖼️",
                title: "Thumbnail Formula That Gets Clicks",
                desc: "Exact thumbnail instructions: background color, text overlay (3 words max), facial expression, and 2 versions to split test. Designed to hit 5-10% CTR.",
                color: "yellow",
              },
              {
                icon: "📈",
                title: "12-Week Content Roadmap",
                desc: "Never run out of content ideas. Jarvis builds a 12-week roadmap around your exact niche and audience — with specific topics for each week.",
                color: "green",
              },
              {
                icon: "📊",
                title: "Growth Dashboard & Milestones",
                desc: "Track subscribers, views, and engagement daily. See your progress toward milestones like YouTube Partner Program. Celebrate every win.",
                color: "cyan",
              },
              {
                icon: "💰",
                title: "Revenue Projections",
                desc: "See exactly what you can earn in 30, 60, and 90 days if you follow the plan. AdSense, sponsorships, courses, products — all mapped out.",
                color: "yellow",
              },
            ].map(item => (
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-[#1a1d27] border-2 border-cyan-500 rounded-2xl p-6 text-left relative">
              ...
              <Link href="/signup" className="block w-full text-center bg-cyan-500 hover:bg-cyan-400 text-black font-bold px-4 py-3 rounded-xl text-sm transition-colors">
            ...
            {[
              {
                ...
                a: "Jarvis works for YouTube, TikTok, Instagram, Amazon, Etsy, and Shopify. More platforms coming soon.",
              },
              {
                q: "Do I need technical knowledge to use Jarvis?",
                a: "No. Jarvis is built for creators and sellers, not developers. Everything is copy-paste ready with step-by-step instructions.",
              },
              {
                q: "How is Jarvis different from TubeBuddy or VidIQ?",
                a: "TubeBuddy and VidIQ only work for YouTube and give you data. Jarvis works for all platforms, speaks like a coach, writes your hook scripts, builds your roadmap, and teaches you exactly HOW to implement every recommendation.",
              },
              {
                q: "How long does an analysis take?",
                a: "About 15-30 seconds. Jarvis analyzes your content and generates a complete growth strategy including SEO tags, hook script, thumbnail formula, 12-week roadmap, and revenue projections.",
              },
              {
              ...
              },
              {
                ...
                a: "Yes! The Free plan lets you analyze 1 source 3 times per month — forever. No credit card required.",
              },
            ].map(item => (
      ...
      <section className="px-6 py-24 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-400 text-lg mb-8">
            Join creators and sellers using Jarvis to grow faster, rank higher, and earn more — starting today.
          </p>
